...
The objective of this study is to glean an understanding into what customers are saying about the app, in an effort to identify an areas where the app is succeeding and where it could be improved. 
...
We have  ``1644`` unique reviews, with the first review issued at ``2015-01-23`` and the newest review, as of time of scraping, posted on ``2020-05-27``
